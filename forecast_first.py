...
argparser.add_argument('-n', help='Number of timeseries', type=int, default=2)
...
# sc = Scaler().fit(train_set)
train_set_scaled = minmaxscale(train_set)
test_set_scaled = minmaxscale(test_set)
...
for i in range(len(testX)):
    ...
    plt.figure()
    plt.plot(test_set_scaled[i, delay:], color='red', label='Real Price')
